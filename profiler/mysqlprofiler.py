...
from tableprocessor import MysqlTableProcessor
...
def main():
	...
	for i,table in enumerate(tables):
		try:
			...
			tableProcessor = MysqlTableProcessor(db_host=config['subjectdb']['db_host'], db_user=config['subjectdb']['db_user'], db_password=config['subjectdb']['db_password'], table=table)
